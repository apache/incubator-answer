...
func initApplication(debug bool, serverConf *conf.Server, dbConf *data.Database, cacheConf *data.CacheConf, i18nConf *translator.I18n, swaggerConf *router.SwaggerConfig, serviceConf *service_config.ServiceConfig, logConf log.Logger) (*pacman.Application, func(), error) {
	...
	commentService := comment2.NewCommentService(commentRepo, commentCommonRepo, questionCommon, answerRepo, userCommon, objService, voteRepo, emailService, userRepo, notificationQueueService, externalNotificationQueueService, activityQueueService)
	...
	rankService := rank2.NewRankService(userCommon, questionCommon, answerRepo, userRankRepo, objService, userRoleRelService, rolePowerRelService, configService)
