...
export const TIMEZONES = [
  {
    ...
    options: [
      ...
      { value: 'Africa/Addis Ababa', label: 'Addis Ababa' },
      ...
      { value: 'Africa/Dar es Salaam', label: 'Dar es Salaam' },
      { value: 'Africa/Djibouti', label: 'Djibouti' },
      { value: 'Africa/Douala', label: 'Douala' },
      { value: 'Africa/El Aaiun', label: 'El Aaiun' },
      ...
      { value: 'Africa/Sao Tome', label: 'Sao Tome' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'America/Argentina/La Rioja', label: 'Argentina - La Rioja' },
      ...
      { value: 'America/Argentina/San Juan', label: 'Argentina - San Juan' },
      { value: 'America/Argentina/San Luis', label: 'Argentina - San Luis' },
      ...
      { value: 'America/Bahia Banderas', label: 'Bahia Banderas' },
      ...
      { value: 'America/Boa Vista', label: 'Boa Vista' },
      { value: 'America/Bogota', label: 'Bogota' },
      { value: 'America/Boise', label: 'Boise' },
      { value: 'America/Cambridge Bay', label: 'Cambridge Bay' },
      { value: 'America/Campo Grande', label: 'Campo Grande' },
      ...
      { value: 'America/Costa Rica', label: 'Costa Rica' },
      ...
      { value: 'America/Dawson Creek', label: 'Dawson Creek' },
      ...
      { value: 'America/El Salvador', label: 'El Salvador' },
      { value: 'America/Fort Nelson', label: 'Fort Nelson' },
      { value: 'America/Fortaleza', label: 'Fortaleza' },
      { value: 'America/Glace Bay', label: 'Glace Bay' },
      { value: 'America/Godthab', label: 'Godthab' },
      { value: 'America/Goose Bay', label: 'Goose Bay' },
      { value: 'America/Grand Turk', label: 'Grand Turk' },
      ...
      { value: 'America/Indiana/Tell City', label: 'Indiana - Tell City' },
      ...
      { value: 'America/La Paz', label: 'La Paz' },
      { value: 'America/Lima', label: 'Lima' },
      { value: 'America/Los Angeles', label: 'Los Angeles' },
      { value: 'America/Lower Princes', label: 'Lower Princes' },
      ...
      { value: 'America/North Dakota/Beulah', label: 'North Dakota - Beulah' },
      { value: 'America/North Dakota/Center', label: 'North Dakota - Center' },
      {
      ...
      { value: 'America/Port of Spain', label: 'Port of Spain' },
      { value: 'America/Porto Velho', label: 'Porto Velho' },
      { value: 'America/Puerto Rico', label: 'Puerto Rico' },
      { value: 'America/Punta Arenas', label: 'Punta Arenas' },
      { value: 'America/Rainy River', label: 'Rainy River' },
      { value: 'America/Rankin Inlet', label: 'Rankin Inlet' },
      { value: 'America/Recife', label: 'Recife' },
      { value: 'America/Regina', label: 'Regina' },
      { value: 'America/Resolute', label: 'Resolute' },
      { value: 'America/Rio Branco', label: 'Rio Branco' },
      { value: 'America/Santarem', label: 'Santarem' },
      { value: 'America/Santiago', label: 'Santiago' },
      { value: 'America/Santo Domingo', label: 'Santo Domingo' },
      { value: 'America/Sao Paulo', label: 'Sao Paulo' },
      { value: 'America/Scoresbysund', label: 'Scoresbysund' },
      { value: 'America/Sitka', label: 'Sitka' },
      { value: 'America/St Barthelemy', label: 'St Barthelemy' },
      { value: 'America/St Johns', label: 'St Johns' },
      { value: 'America/St Kitts', label: 'St Kitts' },
      { value: 'America/St Lucia', label: 'St Lucia' },
      { value: 'America/St Thomas', label: 'St Thomas' },
      { value: 'America/St Vincent', label: 'St Vincent' },
      { value: 'America/Swift Current', label: 'Swift Current' },
      { value: 'America/Tegucigalpa', label: 'Tegucigalpa' },
      { value: 'America/Thule', label: 'Thule' },
      { value: 'America/Thunder Bay', label: 'Thunder Bay' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'Asia/Ho Chi Minh', label: 'Ho Chi Minh' },
      { value: 'Asia/Hong Kong', label: 'Hong Kong' },
      ...
      { value: 'Asia/Kuala Lumpur', label: 'Kuala Lumpur' },
      ...
      { value: 'Asia/Phnom Penh', label: 'Phnom Penh' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'Australia/Broken Hill', label: 'Broken Hill' },
      ...
      { value: 'Australia/Lord Howe', label: 'Lord Howe' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'Europe/Isle of Man', label: 'Isle of Man' },
      ...
      { value: 'Europe/San Marino', label: 'San Marino' },
