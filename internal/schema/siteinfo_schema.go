...
type SiteGeneralReq struct {
	...
	SiteUrl          string `validate:"required,gt=1,lte=128" form:"site_url" json:"site_url"`
	ContactEmail     string `validate:"required,gt=1,lte=128" form:"contact_email" json:"contact_email"`
}
